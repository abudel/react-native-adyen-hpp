...
public class RNAdyenHPPModule extends ReactContextBaseJavaModule {
  ...
  public RNAdyenHPPModule(ReactApplicationContext reactContext) {
    super(reactContext);
  }
  ...
  @ReactMethod
  public void show(String url, ReadableMap option, Promise promise) {
